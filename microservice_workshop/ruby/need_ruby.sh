...
# docker run --name='workshop_need_ruby' -it -v c:/Users/dev/src/microservice_workshop/ruby:/workshop -w /workshop/rental_offer fredgeorge/microservice_ruby:latest bash
...
# docker start -i workshop_need_ruby
